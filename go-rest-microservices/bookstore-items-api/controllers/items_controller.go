...
import (
	"net/http"
	"proeftuin/go-rest-microservices/bookstore-oauth-go/oauth"
	"proeftuin/go-rest-microservices/bookstore-items-api/domain/items"
	"proeftuin/go-rest-microservices/bookstore-items-api/utils/http_utils"
	"io/ioutil"
	"proeftuin/go-rest-microservices/bookstore-utils-go/rest_errors"
	"encoding/json"
	"fmt"
	"github.com/gorilla/mux"
	"strings"
	"proeftuin/go-rest-microservices/bookstore-items-api/domain/queries"
	"proeftuin/go-rest-microservices/bookstore-items-api/services"
)
